  ...
  <div class="flex flex-wrap gap-4">
    {#each avatars as option (option.id)}
      <button
        type="button"
        class="
          avatar-option focus-visible:ring-primary relative rounded-full transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 {value ===
          option.id
          ? 'scale-110'
          : 'hover:scale-105'}
        "
