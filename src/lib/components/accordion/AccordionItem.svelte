...
<div
  class="collapse collapse-arrow join-item border border-base-300 {className}"
  {...props}
>
  ...
  <div
    class="collapse-content peer-checked:bg-base-100 peer-checked:text-base-content"
  >
    <div class="p-4">
      {@render children()}
    </div>
