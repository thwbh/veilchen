...
<div class="flex flex-col gap-6 p-4">
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Standard confirm/cancel dialog with callbacks
    </p>
  ...
  <div>
    ...
    <button class="btn btn-error" onclick={() => dialog2?.showModal()}>
      Delete Item
    </button>
  ...
  <div>
    ...
    <button class="btn btn-secondary" onclick={() => dialog3?.showModal()}>
      Add User
    </button>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Dialog with custom footer snippet and multiple buttons
    </p>

    <button class="btn btn-accent" onclick={() => dialog4?.showModal()}>
      Edit Document
    </button>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Simple informational dialog with custom close button
    </p>

    <button class="btn btn-info" onclick={() => dialog5?.showModal()}>
      Show Info
    </button>
  </div>
  ...
  <div>
    ...
    <button class="btn" onclick={() => dialog6?.showModal()}>
...
<ModalDialog bind:dialog={dialog4}>
  ...
  {#snippet footer()}
    ...
    <button class="btn btn-secondary" onclick={handleSaveAndClose}>
      Save & Close
    </button>
...
<ModalDialog bind:dialog={dialog5}>
  ...
  {#snippet content()}
    ...
    <p class="mt-4">
      This modal demonstrates a simple informational dialog without requiring
      user confirmation.
    </p>
  {/snippet}

  {#snippet footer()}
    <button class="btn btn-primary" onclick={() => dialog5?.close()}>
      Got it!
    </button>
  {/snippet}
</ModalDialog>
...
<ModalDialog bind:dialog={dialog6}>
  ...
  {#snippet content()}
    <div class="prose prose-sm max-h-96 overflow-y-auto">
      ...
      <p>
        Welcome to our service. By using this application, you agree to be bound
      ...
      <h4>4. Data Usage</h4>
      <p>
        By using our service, you consent to the collection and use of your data
      ...
      <p>
        ...
        consequential damages arising out of or in connection with our service.
      </p>
  ...
  {#snippet footer()}
    <button class="btn btn-primary" onclick={() => dialog6?.close()}>
      I Agree
    </button>
    <button class="btn btn-ghost" onclick={() => dialog6?.close()}>
      Close
    </button>
  {/snippet}
</ModalDialog>
