...
<div class="container mx-auto p-4">
  ...
  <div class="prose mb-6">
    <p>
      Vertical or horizontal menu component with support for nested submenus,
      titles, icons, and various states. Built with DaisyUI styling.
    </p>
  </div>
  ...
  <div class="card bg-base-200 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/70 mb-4 text-sm">
        Simple vertical menu with clickable items
      </p>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div>
          <span class="mb-2 block text-xs font-semibold uppercase opacity-70"
          >Extra Small</span>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/70 mb-4 text-sm">
        Active and disabled menu items
      </p>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <div
        class="bg-base-100 mt-4 grid gap-4 rounded-lg p-6 md:grid-cols-[250px_1fr]"
      >
        <Menu
          items={[
            {
