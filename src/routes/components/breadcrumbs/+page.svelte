...
<div class="container mx-auto p-4">
  ...
  <div class="prose mb-6">
    <p>
      Breadcrumbs show the current location within a hierarchy and allow
      navigation to parent pages. Perfect for multi-level navigation structures.
    </p>
  </div>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <div class="alert alert-info mt-4">
        ...
        <span>
          The last item in the breadcrumbs array is automatically rendered as
          non-clickable, representing the current page.
        </span>
      </div>
    </div>
  </div>
