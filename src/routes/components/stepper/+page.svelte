...
<div class="flex flex-col gap-8 p-4">
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Multi-step wizard with progress indicator, smooth animations, and
      navigation controls
    </p>
  </div>
      ...
      {#snippet step2()}
        <div class="p-4">
          ...
          <p class="text-sm opacity-70">
            This step has more content to demonstrate the smooth height
  ...
  <section>
    ...
    <p class="mb-4 text-sm opacity-70">
      Buttons stick to the bottom while content scrolls independently - perfect
      for long forms
    </p>
      ...
      >
        {#snippet step1()}
          <div class="p-4">
            ...
            <p class="mb-4">
              This step has a lot of content. Scroll down to see the buttons
            ...
            <p class="text-sm opacity-70">
              Notice how the buttons remain accessible even with all this
              content!
            </p>
          </div>
        {/snippet}
