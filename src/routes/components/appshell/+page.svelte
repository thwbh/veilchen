...
<div class="flex flex-col gap-6 p-4">
  ...
  <p class="mb-4 text-sm opacity-70">
    Mobile app layout structure with bottom navigation and SvelteKit routing
    integration
  </p>
        ...
        <div class="h-fit w-fit">
          ...
          <div class="p-4">
            ...
            <p class="mt-2 text-sm opacity-70">
              This is the content area. It scrolls independently of the bottom
              navigation.
            </p>
          </div>
    ...
    <div class="space-y-6 text-sm">
      <div>
        <h4 class="mb-2 font-bold">
          Option 1: Using AppShell Component (Recommended)
        </h4>
        <p class="mb-3 opacity-70">
          Best for most apps. Provides layout structure and handles scroll
        ...
        <div class="space-y-3">
          <div>
            <p class="mb-2 font-semibold">
              1. Create a route group for your app
            </p>
...
└── (app)/                   ← Route group (doesn't affect URLs)
    ...
    └── profile/
        └── +page.svelte     ← /profile</code
          ...
          <div>
            <p class="mb-2 font-semibold">
              2. Set up your app layout with AppShell
            </p>
            <pre class="bg-base-300 rounded p-3"><code
...
&lt;/div&gt;</code
      ...
      <div>
        <h4 class="mb-2 font-bold">
          Option 2: Using BottomNavigation Directly
        </h4>
        <p class="mb-3 opacity-70">
          More flexible. You control the layout structure yourself.
        </p>
...
&lt;/style&gt;</code
      ...
      <div>
        ...
        <p class="mb-3 opacity-70">
          Pages outside the (app) route group won't have navigation.
        </p>
...
&lt;/div&gt;</code
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <ul class="list-inside list-disc space-y-1 text-sm">
      ...
      <li>
        Progressive enhancement (works without JS via <code>&lt;a&gt;</code>
        tags)
      </li>
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <div class="text-sm">
      ...
      <ul class="mb-4 list-inside list-disc space-y-1 opacity-70">
        ...
        <li>
          <code>navbar?: NavBarConfig</code> - Optional navbar configuration for
          top navigation
        </li>
        <li><code>class?: string</code> - Additional CSS classes for shell</li>
        <li>
          <code>contentClass?: string</code> - Additional CSS classes for
          content area
        </li>
        <li>
          <code>navClass?: string</code> - Additional CSS classes for navigation
        </li>
        <li>
          <code>loading?: boolean</code> - Show/hide loading progress bar
          (default: false)
        </li>
        <li>
          <code>loadingColor?: 'progress-primary' | 'progress-secondary' |
            'progress-accent' | ...</code> - Progress bar color (default:
          'progress-primary')
        </li>
        <li>
          <code>onrefresh?: () => void | Promise&lt;void&gt;</code> - Callback
          for pull-to-refresh. If provided, enables pull-to-refresh
        </li>
        <li>
          <code>refreshing?: boolean</code> - Whether a refresh is in progress
          (bindable)
        </li>
        <li>
          <code>refreshIndicator?: Snippet&lt;[number]&gt;</code> - Custom
          refresh indicator snippet
        </li>
      </ul>
      ...
      <ul class="list-inside list-disc space-y-1 opacity-70">
        ...
        <li>
          <code>href?: string</code> - Navigation URL (optional, uses <code
          >&lt;a&gt;</code> tag)
        </li>
        <li>
          <code>icon?: Component</code> - Icon component (optional, e.g.
          phosphor-svelte icons)
        </li>
        <li>
          <code>iconProps?: Record&lt;string, any&gt;</code> - Props to pass to
          icon component
        </li>
        <li>
          <code>onclick?: () => void</code> - Click handler for this specific
          item (optional)
        </li>
      </ul>
    </div>
...
&lt;/AppShell&gt;</code
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <p class="mb-3 text-sm opacity-70">
      Since AppShell is used in layouts, child routes need to communicate their
      refresh handler to the parent. Use the provided context utilities:
    </p>

    <div class="space-y-4">
      <div>
        <p class="mb-2 text-sm font-semibold">
          1. In your layout with AppShell:
        </p>
        <pre class="bg-base-300 rounded p-3 text-xs"><code
						>&lt;!-- src/routes/(app)/+layout.svelte --&gt;
&lt;script lang="ts"&gt;
