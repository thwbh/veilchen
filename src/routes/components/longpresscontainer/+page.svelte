...
<div class="flex flex-col gap-6 p-4">
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      A container that wraps content and triggers callbacks on long press
      gestures (300ms)
    </p>
  </div>
  ...
  <div class="alert alert-info">
    ...
    <span>Touch and hold any item below for 300ms to trigger the long press
      action</span>
  </div>
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <div class="text-sm">
      ...
      <p>
        Last pressed: <span class="font-bold">{lastPressedItem || "None"}</span>
      </p>
    </div>
  </div>
  ...
  <div>
    ...
    <LongPressContainer
      onlongpress={() => handleLongPress("Card 1")}
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Long press button element for delete action
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Long press list items for context menu
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Long press images for download/share options
    </p>
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <ul class="list-inside list-disc space-y-1 text-sm opacity-70">
      <li>
        <code>onlongpress: () => void</code> - Callback triggered on long press
        (required)
      </li>
      <li>
        <code>as?: 'div' | 'button' | 'article' | 'section' | 'li'</code> - HTML
        element type (default: 'div')
      </li>
      <li><code>class?: string</code> - Additional CSS classes</li>
      <li>
        <code>children: Snippet</code> - Content to display inside the container
      </li>
    </ul>
  </div>
