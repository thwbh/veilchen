  ...
  let emails = $state<Email[]>([
    {
      ...
      preview:
        "Hey, just wanted to confirm our meeting for tomorrow at 10 AM...",
      time: "9:30 AM",
      unread: true,
    },
    {
      ...
      preview:
        "The latest version of the project has been deployed to staging...",
      time: "8:15 AM",
      unread: true,
    },
    {
      ...
      preview:
        "Thanks for sending over the budget proposal. I have a few questions...",
      time: "Yesterday",
      unread: false,
    },
    {
      ...
      subject: "Team Lunch",
      preview:
        "Who wants to grab lunch today? Thinking about that new place...",
      time: "Yesterday",
      unread: false,
    },
    {
      ...
      preview:
        "Could you review my PR when you get a chance? It adds the new...",
      time: "2 days ago",
      unread: false,
    },
  ]);
...
<div class="container mx-auto p-4">
  ...
  <div class="prose mb-6">
    <p>
      A swipeable list item component that automatically executes actions when
      swiped. Supports both touch and pointer events (mouse, pen).
    </p>
    <p class="text-base-content/70 text-sm">
      Swipe left or right past the threshold to trigger the action
      ...
      <div class="divide-base-300 divide-y">
        {#each emails as email (email.id)}
          ...
          >
            ...
            <div
              class="hover:bg-base-100 flex items-start gap-4 p-4 transition-colors"
            >
              <div class="min-w-0 flex-1">
                <div class="mb-1 flex items-center gap-2">
                  <span
                    class="truncate font-semibold {email.unread ? 'text-primary' : ''}"
                  >
                    {email.from}
                  </span>
                  {#if email.unread}
                ...
                <div
                  class="mb-1 text-sm font-medium {email.unread ? 'text-primary' : ''}"
                >
                  {email.subject}
                </div>
        ...
        {#each [1, 2, 3] as item}
          ...
          >
            ...
            <div class="bg-base-100 p-4">
              ...
              <p class="text-base-content/70 text-sm">
                Swipe to trigger action automatically
              </p>
            </div>
          </SwipeableListItem>
        {/each}
      ...
      <div class="divide-base-300 divide-y">
        <SwipeableListItem onright={() => console.log("Deleted")}>
          ...
          <div class="bg-base-100 p-4">
            ...
            <p class="text-base-content/70 text-sm">
              This item only has a right-side action
            </p>
          </div>
        </SwipeableListItem>
        ...
        <SwipeableListItem onleft={() => console.log("Info shown")}>
          ...
          <div class="bg-base-100 p-4">
            ...
            <p class="text-base-content/70 text-sm">
              This item only has a left-side action
            </p>
          </div>
        </SwipeableListItem>
      </div>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
        ...
        <table class="table-zebra table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                Callback fired when left action is triggered (swiped right
                fully)
              </td>
            </tr>
            <tr>
              ...
              <td>-</td>
              <td>
                Callback fired when right action is triggered (swiped left
                fully)
              </td>
            </tr>
            <tr>
      ...
      <div class="alert alert-info mt-4">
        ...
        <span>
          <strong>Automatic execution:</strong> Actions are automatically
          triggered when you swipe past the threshold and release. No need to
          click buttons!
        </span>
      </div>
    </div>
