...
<div class="flex flex-col gap-6 p-4">
  ...
  <p class="mb-2 text-sm opacity-70">
    Number input with increment/decrement buttons and configurable step sizes
    via iOS-style wheel pickers
  </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Temperature control with min/max constraints
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Weight adjustment with custom step sizes
    </p>
    ...
    <div class="bg-base-200 rounded-box mt-4 p-4">
      ...
      <p class="mt-1 text-xs opacity-70">
        Try clicking the step size buttons (-1, +1) to change the
  ...
  <div>
    <h2 class="mb-2 text-2xl font-bold">
      Example 4: Number Stepper with Large Steps
    </h2>
    <p class="mb-4 text-sm opacity-70">
      Distance tracker with larger increments
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Different step sizes for increment and decrement
    </p>
  ...
  <div class="bg-info/20 rounded-box p-4">
    ...
    <ul class="list-inside list-disc space-y-1 text-sm opacity-80">
      <li>
        Click the minus (-) or plus (+) buttons to decrement/increment the value
      </li>
      <li>Swipe up/down on the number wheels to change the step size</li>
      <li>
        The selected step size will be used for subsequent increment/decrement
        operations
      </li>
      <li>
        When only one wheel is visible, both buttons use the same step value
      </li>
