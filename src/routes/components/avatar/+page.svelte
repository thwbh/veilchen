<script lang="ts">
  ...
  const loreleiAvatars: AvatarOption[] = [
    {
      id: "felix",
      src: new DicebearAvatar(loreleiStyle, { seed: "Felix" }).toDataUri(),
    },
    {
      id: "aneka",
      src: new DicebearAvatar(loreleiStyle, { seed: "Aneka" }).toDataUri(),
    },
    {
      id: "luna",
      src: new DicebearAvatar(loreleiStyle, { seed: "Luna" }).toDataUri(),
    },
    {
      id: "max",
      src: new DicebearAvatar(loreleiStyle, { seed: "Max" }).toDataUri(),
    },
    {
      id: "bella",
      src: new DicebearAvatar(loreleiStyle, { seed: "Bella" }).toDataUri(),
    },
    {
      id: "charlie",
      src: new DicebearAvatar(loreleiStyle, { seed: "Charlie" }).toDataUri(),
    },
    {
      id: "daisy",
      src: new DicebearAvatar(loreleiStyle, { seed: "Daisy" }).toDataUri(),
    },
    {
      id: "oscar",
      src: new DicebearAvatar(loreleiStyle, { seed: "Oscar" }).toDataUri(),
    },
  ];
  ...
  const thumbsAvatars: AvatarOption[] = [
    {
      id: "avatar1",
      src: new DicebearAvatar(thumbsStyle, { seed: "Felix" }).toDataUri(),
    },
    {
      id: "avatar2",
      src: new DicebearAvatar(thumbsStyle, { seed: "Aneka" }).toDataUri(),
    },
    {
      id: "avatar3",
      src: new DicebearAvatar(thumbsStyle, { seed: "Luna" }).toDataUri(),
    },
    {
      id: "avatar4",
      src: new DicebearAvatar(thumbsStyle, { seed: "Max" }).toDataUri(),
    },
    {
      id: "avatar5",
      src: new DicebearAvatar(thumbsStyle, { seed: "Bella" }).toDataUri(),
    },
    {
      id: "avatar6",
      src: new DicebearAvatar(thumbsStyle, { seed: "Charlie" }).toDataUri(),
    },
    {
      id: "avatar7",
      src: new DicebearAvatar(thumbsStyle, { seed: "Daisy" }).toDataUri(),
    },
    {
      id: "avatar8",
      src: new DicebearAvatar(thumbsStyle, { seed: "Oscar" }).toDataUri(),
    },
  ];
...
<div class="container mx-auto p-4">
  ...
  <div class="prose mb-6">
    <p>
      Avatar components for displaying user profile pictures with various sizes,
      shapes, and status indicators. Perfect for user profiles, comments, and
      team displays.
    </p>
  </div>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/70 mt-2 text-sm">
        Click on the avatars to see the interaction
      </p>
    </div>
  </div>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/70 mb-4 text-sm">
        Select an avatar from predefined options
      </p>
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              <AvatarPicker
                label="Small"
                size="sm"
                avatars={loreleiAvatars.slice(0, 6)}
              />
            </div>
            <div>
              <AvatarPicker
        ...
        <div>
          ...
          <div class="space-y-6">
            <AvatarPicker
              label="Rounded"
              shape="rounded"
              avatars={thumbsAvatars.slice(0, 8)}
            />
            <AvatarPicker
              label="Square"
              shape="square"
        ...
        <table class="table-zebra table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <code>'online' | 'offline' | 'busy' | 'away' | null</code>
              </td>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
        ...
        <table class="table-zebra table">
          ...
          <tbody>
            <tr>
              ...
              <td>-</td>
              <td>
                Maximum avatars before showing "+X" counter (not yet
                implemented)
              </td>
            </tr>
            <tr>
      ...
      <div class="alert alert-info mt-4">
        ...
        <span>
          <strong>DiceBear Integration:</strong> You can easily integrate
          DiceBear by setting the
          <code>src</code> prop to a DiceBear API URL for procedurally generated
          avatars!
        </span>
      </div>
    </div>
        ...
        <table class="table-zebra table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                Array of avatar options. Each option has: <code>id</code>
                (string), <code>src</code>
                (string - URL, file path, or data URI), <code>alt</code>
                (optional string)
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <code>(id: string, option: AvatarOption) =&gt; void</code>
              </td>
              <td>-</td>
