...
<div class="flex flex-col gap-6 p-4">
  ...
  <p class="mb-4 text-sm opacity-70">
    Segmented control component with mobile optimizations
  </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Swipe left/right to navigate (mobile only)
    </p>
    ...
    <div class="mt-2 text-sm opacity-70">
      Selected: <strong>{mobileValue}</strong>
      {
        ...
        : " 🖥️ Swipe gestures work on touch devices"
      }
    </div>
  </div>
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <ul class="list-inside list-disc space-y-1 text-sm opacity-80">
      <li>
        <strong>Large touch targets:</strong> Minimum 48px height for easy
        tapping
      </li>
      <li>
        <strong>Swipe gestures:</strong> Swipe left/right to navigate options
      </li>
      ...
      <li>
        <strong>Responsive sizing:</strong> Three size variants (sm/md/lg)
      </li>
      <li>
        <strong>Accessibility:</strong> Proper ARIA attributes and touch targets
      </li>
    </ul>
  </div>
</div>
