<script lang="ts">
  ...
  function startProgressLoop() {
    ...
    animationRef = setInterval(() => {
      if (
        moveProgress >= 560 && exerciseProgress >= 35 && standProgress >= 10
      ) {
...
<div class="flex flex-col gap-6 p-4">
  ...
  <div>
    ...
    <div class="flex flex-wrap items-center gap-8">
      ...
      <div class="flex flex-col gap-3">
        ...
        <div>
          <label for="goal-steps" class="label-text text-sm opacity-70">Goal: {
              stepsGoal
            }</label>
          <input
            id="goal-steps"
        ...
        <div class="flex gap-2">
          <button
            ...
            onclick={() => (steps = stepsGoal)}
          >
            Complete
          </button>
          <button class="btn btn-sm btn-ghost" onclick={() => (steps = 0)}>
            Reset
          </button>
        </div>
      </div>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Three-ring layout with legend — animated on mount
    </p>
    ...
    <div class="flex flex-wrap items-center gap-8">
      ...
      <div class="flex flex-col gap-3">
        ...
        <button class="btn btn-primary" onclick={startProgressLoop}>
          Restart Animation
        </button>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Pass custom content via the children slot
    </p>
