...
<div class="flex flex-col gap-6 p-4">
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Adjust the size of the loading indicator
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Customize the color using DaisyUI text color classes
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Display text below the loading indicator
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Toggle the loading indicator on and off
    </p>
  ...
  <div>
    ...
    <p class="mb-4 text-sm opacity-70">
      Show completion or error messages when loading finishes
    </p>
  ...
  <div class="bg-base-200 rounded-lg p-4">
    ...
    <ul class="list-inside list-disc space-y-1 text-sm opacity-70">
      <li>
        <code>variant?: 'spinner' | 'dots' | 'ring' | 'ball' | 'bars' |
          'infinity'</code> - Animation style (default: 'spinner')
      </li>
      <li>
        <code>size?: 'xs' | 'sm' | 'md' | 'lg' | 'xl'</code> - Size of the
        indicator (default: 'md')
      </li>
      <li>
        <code>color?: string</code> - Color class (default: 'text-primary')
      </li>
      <li>
        <code>label?: string</code> - Optional text to display below the
        indicator
      </li>
      <li>
        <code>visible?: boolean</code> - Controls visibility (default: true)
      </li>
      <li>
        <code>finished?: boolean</code> - When true, shows finished state
        (default: false)
      </li>
      <li>
        <code>finishedContent?: Snippet</code> - Custom snippet for finished
        state
      </li>
      <li>
        <code>error?: boolean</code> - When true, shows error state (default:
        false)
      </li>
      <li>
        <code>errorContent?: Snippet</code> - Custom snippet for error state
      </li>
