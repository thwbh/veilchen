...
<div class="container mx-auto p-4">
  ...
  <div class="prose mb-6">
    <p>
      Transient notification surface with optional action button, designed for
      the "undo" pattern and other user feedback scenarios. Snackbars differ
      from Toasts by supporting action callbacks and richer lifecycle
      management.
    </p>
  </div>
  ...
  <div class="card bg-base-200 shadow-xl">
    <div class="card-body">
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <button class="btn btn-primary" onclick={showSimpleSnackbar}>
          Simple Snackbar
        </button>
        ...
        <button class="btn btn-info" onclick={showNonDismissibleSnackbar}>
          Non-Dismissible
        </button>
      </div>
    </div>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/70 mb-4 text-sm">
        The canonical undo pattern: perform an action optimistically, offer undo
        via snackbar action button.
      </p>
  ...
  <div class="card bg-base-200 mt-8 shadow-xl">
    <div class="card-body">
      ...
      <div class="mt-4 flex gap-4">
        <button class="btn btn-ghost" onclick={clearAllSnackbars}>
          Clear All Snackbars
        </button>
        <button class="btn btn-ghost" onclick={resetCounters}>
          Reset Counters
        </button>
      </div>
    </div>
        ...
        <div>
          ...
          <button
            ...
            snackbar.add("5 items archived", {
              actionLabel: "Undo",
              onAction: () =>
                snackbar.show("Items restored!", undefined, undefined, 2000),
              duration: 6000,
            })}
          >
      ...
      <div class="overflow-x-auto">
        <table class="table-zebra table">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <code>show(message, actionLabel, onAction, duration)</code>
              </td>
              <td>
                <code>message: string</code><br />
        ...
        <table class="table-zebra table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <code>(reason: SnackbarDismissReason) => void | undefined</code>
              </td>
              <td>-</td>
    ...
    <div class="card-body">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <div class="mockup-code">
            <pre><code
								>interface SnackbarMessage &lbrace;
  id: string;
  message: string;
  actionLabel?: string;
  onAction?: () =&gt; void;
...
&rbrace;</code
      ...
      <div class="alert alert-info mt-6">
        ...
        <span>
          <strong>Key Difference from Toast:</strong> Snackbar supports action
          callbacks and dismiss reason tracking, making it ideal for undo
          patterns and interactive notifications.
        </span>
      </div>
    </div>
  </div>
      ...
      <div class="space-y-6">
        <div>
          ...
          <div class="bg-base-300 rounded p-3 font-mono text-sm">
            <code>&lt;SnackbarContainer position="bottom" align="center"
              /&gt;</code><br /><br />
        ...
        <div>
          ...
          <div class="bg-base-300 rounded p-3 font-mono text-sm">
            <code>snackbar.add('Items deleted', &lbrace;</code><br />
            <code>&nbsp;&nbsp;actionLabel: 'Undo',</code><br />
            <code>&nbsp;&nbsp;onAction: () =&gt; &lbrace;</code><br />
            <code>&nbsp;&nbsp;&nbsp;&nbsp;// Restore deleted items</code><br />
            <code>&nbsp;&nbsp;&nbsp;&nbsp;items =
              [...deletedItems];</code><br />
            <code>&nbsp;&nbsp;&rbrace;,</code><br />
            <code>&nbsp;&nbsp;onDismiss: (reason) =&gt; &lbrace;</code><br />
            <code>&nbsp;&nbsp;&nbsp;&nbsp;if (reason === 'timeout')
              &lbrace;</code><br />
            <code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Items permanently
              deleted</code><br />
            <code>&nbsp;&nbsp;&nbsp;&nbsp;&rbrace;</code><br />
            <code>&nbsp;&nbsp;&rbrace;,</code><br />
        ...
        <div>
          ...
          <div class="bg-base-300 rounded p-3 font-mono text-sm">
            ...
            <code>snackbar.add('Quick message', &lbrace; duration: 2000
              &rbrace;);</code><br /><br />
            <code>// Persistent (manual dismiss only)</code><br />
            <code>snackbar.add('Important message', &lbrace; duration: 0
              &rbrace;);</code>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="bg-base-300 rounded p-3 font-mono text-sm">
            <code>snackbar.add('Critical alert', &lbrace;</code><br />
